...
![](linear_regression_files/figure-gfm/unnamed-chunk-10-2.png)<!-- -->
...
![](linear_regression_files/figure-gfm/unnamed-chunk-10-3.png)<!-- -->
...
shortly we’ll look at using the bootstrap for inference in cases like
this, where standard approaches to inference may fail.
...
We’ll comment briefly on hypothesis testing. Model summaries include
...
What about significance of borough? We have to do F test and Anova - so
we must fit_null ( a null model) price against stars if the null is that
borough is not associated with price is true and we won’t place in
model.
...
- Is there an association with stars and price and does it differ by
  borough?
